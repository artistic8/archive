...
for ($raceNumber = 1; $raceNumber <= $numberOfRaces; $raceNumber++) {
    ...
    if(count($surePlace) > 1 && !empty(array_intersect($surePlace, $favorites)) && count(array_intersect($surePlace, $favorites)) < 2){
    ...
    if(isset($officialWin) && $totalBets[$raceNumber] > 0 && count($surePlace) > 1 && !empty(array_intersect($surePlace, $favorites)) && count(array_intersect($surePlace, $favorites)) < 2){
