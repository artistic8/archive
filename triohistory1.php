...
return [
    1 => [
        ...
        2 => [
            ...
            'trio' => [[1, 2, 3], [1, 2, 8], [1, 8, 11], [1, 13, 14], [2, 3, 4], [2, 4, 9], [2, 4, 11], [2, 5, 10], [2, 5, 12], [2, 8, 12], [3, 8, 9], [4, 8, 12]]
        ],
        3 => [
            'win' => [1, 3, 4, 5, 6, 7],
    ...
    2 => [
        ...
        3 => [
            ...
            'qin' => [[1, 2], [1, 13], [2, 3], [2, 8], [3, 4], [3, 10], [3, 12], [4, 8], [5, 11], [5, 12], [7, 12]],
    ...
    3 => [
        1 => [
            'win' => [1, 2, 4, 5, 8, 10, 11],
            'qin' => [[1, 2], [1, 3], [1, 10], [3, 5], [4, 8], [4, 11], [5, 8], [8, 10]],
            'trio' => [[1, 2, 7], [1, 3, 9], [1, 3, 10], [1, 5, 8], [2, 3, 5], [2, 4, 8], [2, 8, 10], [4, 7, 11]]
        ],
        2 => [
            'win' => [1, 2, 8, 10, 12],
        ...
        7 => [
            'win' => [3, 5, 6, 7, 11, 12],
            'qin' => [[1, 3], [2, 7], [3, 5], [4, 11], [4, 12], [5, 7], [6, 9], [6, 11], [7, 8], [7, 11]],
            'trio' => [[1, 3, 14], [2, 4, 7], [2, 6, 11], [2, 7, 11], [3, 5, 7], [4, 6, 9], [4, 7, 11], [4, 8, 12], [5, 7, 11], [7, 8, 9]]
        ],
        8 => [
            'win' => [1, 8, 10, 11],
    ...
    4 => [
        1 => [
            'win' => [2, 3, 5, 6, 10, 11],
            'qin' => [[1, 2], [1, 5], [1, 6], [1, 11], [2, 3], [2, 5], [3, 12], [4, 10], [5, 9], [5, 10], [6, 7]],
            'trio' => [[1, 2, 4], [1, 5, 6], [1, 5, 9], [1, 6, 12], [1, 10, 11], [2, 3, 12], [2, 4, 5], [3, 4, 10], [3, 6, 12], [5, 8, 10], [6, 7, 10]]
        ],
        2 => [
            'win' => [2, 7, 9, 10, 12, 13],
        ...
        4 => [
            'win' => [3, 4, 9, 11],
            'qin' => [[1, 11], [2, 4], [3, 4], [3, 11], [4, 9], [9, 11]],
            'trio' => [[1, 10, 11], [2, 4, 14], [2, 9, 11], [3, 4, 5], [3, 4, 10], [3, 9, 11], [4, 6, 9]]
        ],
        5 => [
            'win' => [4, 7, 10, 12],
    ...
    5 => [
        ...
        4 => [
            'win' => [1, 2, 3, 4, 6],
            'qin' => [[1, 3], [1, 10], [2, 6], [2, 11], [2, 12], [4, 5], [6, 11]],
            'trio' => [[1, 3, 4], [1, 4, 10], [2, 4, 6], [2, 9, 12], [2, 11, 13], [4, 5, 11], [4, 6, 11]]
        ],
        5 => [
            'win' => [1, 3, 5, 12],
    ...
    6 => [
        1 => [
            'win' => [1, 3, 7, 9, 12, 13],
            'qin' => [[1, 5], [1, 7], [1, 10], [1, 12], [2, 3], [2, 13], [5, 9]],
            'trio' => [[1, 4, 12], [1, 5, 7], [1, 7, 9], [1, 10, 12], [2, 3, 9], [2, 11, 13], [3, 5, 9]]
        ],
        2 => [
            'win' => [2, 3, 4, 5, 8, 10],
        ...
        3 => [
            'win' => [1, 3, 5, 9, 11],
            'qin' => [[1, 4], [2, 3], [2, 5], [2, 11], [3, 5], [3, 7], [3, 11], [3, 12], [9, 11]],
            'trio' => [[1, 3, 11], [1, 4, 7], [2, 3, 5], [2, 3, 9], [2, 3, 11], [3, 7, 10], [3, 8, 12], [3, 10, 12], [6, 9, 11]]
        ],
        4 => [
            'win' => [3, 6, 7, 8, 12, 13],
        ...
        7 => [
            'win' => [3, 6, 9, 11, 13],
            'qin' => [[2, 3], [3, 14], [4, 6], [7, 11], [7, 13], [9, 11]],
            'trio' => [[2, 3, 9], [2, 4, 6], [2, 7, 13], [3, 13, 14], [6, 9, 11], [7, 9, 11], [7, 10, 11]]
        ],
        8 => [
            'win' => [3, 8, 12],
            'qin' => [[2, 3], [2, 8], [2, 12]],
            'trio' => [[2, 3, 9], [2, 8, 12], [2, 11, 12]]
        ],
        9 => [
            'win' => [2, 5, 7],
    ...
    7 => [
        ...
        3 => [
            'win' => [1, 2, 3, 9],
            'qin' => [[1, 9], [2, 3], [2, 9], [3, 9], [3, 10]],
            'trio' => [[1, 3, 9], [2, 3, 9], [2, 3, 11], [2, 5, 9], [3, 4, 9], [3, 4, 10], [3, 5, 9]]
        ],
        4 => [
            'win' => [1, 3, 4, 5, 7, 8],
        ...
        5 => [
            'win' => [2, 5, 10],
            'qin' => [[2, 5], [2, 9], [5, 8], [6, 10]],
            'trio' => [[1, 6, 10], [2, 3, 5], [2, 5, 9], [5, 6, 8]]
        ],
        6 => [
            'win' => [6, 10],
            'qin' => [[2, 6], [6, 8], [9, 10]],
    ...
    8 => [
        ...
        5 => [
            'win' => [3, 5, 7, 8, 10, 11],
            'qin' => [[2, 3], [2, 11], [3, 5], [3, 7], [5, 8], [5, 10]],
            'trio' => [[1, 3, 7], [2, 3, 4], [2, 4, 11], [3, 5, 8], [3, 5, 12], [4, 5, 10], [5, 6, 8], [5, 10, 11]]
        ],
        6 => [
            'win' => [4, 6, 11, 12],
        ...
        8 => [
            'win' => [1, 3, 8, 12, 13],
            'qin' => [[1, 9], [2, 3], [4, 8], [6, 12], [8, 13]],
            'trio' => [[1, 8, 9], [2, 3, 4], [3, 8, 13], [4, 6, 12], [4, 8, 12]]
        ],
        9 => [
            'win' => [4, 5, 10, 13],
        ...
        10 => [
            'win' => [3, 4, 7, 9, 10],
            'qin' => [[2, 3], [4, 9], [4, 10], [7, 8], [7, 10]],
            'trio' => [[2, 3, 4], [2, 4, 9], [2, 7, 8], [2, 7, 10], [4, 5, 10]]
        ],
        11 => [
            'win' => [4, 9],
            'qin' => [[4, 5], [5, 9]],
    ...
    9 => [
        1 => [
            'win' => [1, 5, 6, 7, 8, 10, 12],
            'qin' => [[1, 4], [1, 5], [1, 10], [3, 12], [4, 5], [5, 8], [6, 8], [7, 13], [10, 12]],
            'trio' => [[1, 2, 10], [1, 4, 5], [1, 5, 6], [1, 6, 10], [1, 7, 13], [3, 10, 12], [3, 11, 12], [4, 5, 10], [5, 8, 9], [6, 7, 8], [6, 8, 9]]
        ],
        2 => [
            'win' => [2, 4, 6, 11],
        ...
        5 => [
            'win' => [3, 5, 8, 11, 12],
            'qin' => [[3, 8], [3, 11], [3, 12], [5, 8], [5, 10]],
            'trio' => [[1, 5, 10], [3, 4, 11], [3, 8, 11], [3, 11, 12], [5, 8, 9]]
        ],
        6 => [
            'win' => [2, 3, 4, 6, 7],
