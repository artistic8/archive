...
return [
	...
	'3' => [
		...
		*/
		...
		'minmax history' => [
			'min history(min, win)' => '9',
			'min history(max, win)' => '',
			'max history(min, win)' => '2, 3, 7, 8, 9',
			'max history(max, win)' => '2, 4',
			'min history(min, qin)' => '9, 10',
			'min history(max, qin)' => '',
			'max history(min, qin)' => '1, 2, 3, 4, 7, 8, 9',
			'max history(max, qin)' => '2, 4, 13, 14',
			'min history(min, trio)' => '9, 10, 13',
			'min history(max, trio)' => '',
			'max history(min, trio)' => '1, 2, 3, 4, 5, 6, 7, 8, 9',
			'max history(max, trio)' => '2, 3, 4, 11, 13, 14',
		],
		'win amount' => 43,
		'qin amount' => 505.5,
		'trio amount' => 286,
	...
	'5' => [
		...
		*/
		...
		'minmax history' => [
			...
			'max history(min, qin)' => '1, 2, 3, 4, 5, 7, 9',
			'max history(max, qin)' => '1, 2, 3, 4, 5, 7, 9',
	...
	'9' => [
		...
		*/
		...
		'minmax history' => [
			...
			'max history(max, trio)' => '1, 2, 3, 5, 10, 11',
		],
		'win amount' => 91,
		'qin amount' => 111,
		'trio amount' => 203,
	...
	'10' => [
		...
		*/
		...
		'minmax history' => [
			...
			'min history(max, win)' => '',
			'max history(min, win)' => '',
			'max history(max, win)' => '2, 3, 14',
			'min history(min, qin)' => '1, 2, 3, 4, 5, 7, 8, 9, 10, 11, 14',
			'min history(max, qin)' => '',
			'max history(min, qin)' => '',
			'max history(max, qin)' => '1, 2, 3, 9, 11, 14',
			'min history(min, trio)' => '1, 2, 3, 4, 5, 7, 8, 9, 10, 11, 13, 14',
			'min history(max, trio)' => '',
			'max history(min, trio)' => '',
			'max history(max, trio)' => '1, 2, 3, 4, 8, 9, 11, 14',
		],
		'win amount' => 89,
		'qin amount' => 1102,
		'trio amount' => 12219,
